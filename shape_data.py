...
class Shaper:
    ...
    def read_prefecture_city_id_info(self):
        ...
        '''
        self.prefecture_city_id_info = pd.read_csv('learning_data/prefecture_city_id_info.csv')
    ...
    def shape_address_col(self, df_: pd.core.frame.DataFrame):
        ...
        df = df_.copy()
        self.prefecture_city_id_info['ward_city_id'] = [int('%d%d' % (prefecture_id, ward_city_id)) for prefecture_id, ward_city_id in zip(self.prefecture_city_id_info.prefecture_id.tolist(), self.prefecture_city_id_info.ward_city_id.tolist())]
        self.prefecture_city_id_info.index = self.prefecture_city_id_info.prefecture_id
        prefecture_dic = self.prefecture_city_id_info.to_dict()['prefecture_name']
        ...
        df['ward_city_id'] = [int('%d%d' % (prefecture_id, ward_city_id)) for prefecture_id, ward_city_id in zip(df.prefecture_id.tolist(), df.ward_city_id.tolist())]
